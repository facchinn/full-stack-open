...
En la versión SPA se carga el HTML, el CSS y el JavaScript. Después el navegador pide los datos y React/JavaScript se ocupa de construir la vista sin depender de una recarga completa de la página.
